...
yum install git maven wget fontconfig -y
...
sudo yum install java-21-amazon-corretto-devel.x86_64 java-21-amazon-corretto-headless.x86_64 java-21-amazon-corretto.x86_64  -y
